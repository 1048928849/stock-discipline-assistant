...
QUALITY_POLICIES: dict[str, CapabilityQualityPolicy] = {
    ...
    "market.intraday.60m": CapabilityQualityPolicy(
        "market.intraday.60m",
        required=True,
        max_trading_session_lag=0,
        business_fields=(
    ...
    "market.turnover.daily": CapabilityQualityPolicy(
        "market.turnover.daily",
        required=True,
        max_trading_session_lag=0,
        business_fields=("symbol", "trade_date", "turnover_rate", "amount"),
        verify_multiple_sources=True,
    ),
    "market.breadth.daily": CapabilityQualityPolicy(
        "market.breadth.daily",
        required=True,
        max_trading_session_lag=0,
        verify_multiple_sources=True,
    ),
    "market.amount.daily": CapabilityQualityPolicy(
        "market.amount.daily",
        required=True,
        max_trading_session_lag=0,
        business_fields=("trade_date", "total_amount"),
        verify_multiple_sources=True,
    ),
    "market.industry.daily": CapabilityQualityPolicy(
    ...
    "market.industry.constituents": CapabilityQualityPolicy(
    ...
    "market.limit_up_pool": CapabilityQualityPolicy(
    ...
    "market.broken_limit_pool": CapabilityQualityPolicy(
    ...
    "company.concepts": CapabilityQualityPolicy(
        "company.concepts",
        required=False,
        max_age=timedelta(days=30),
        verify_multiple_sources=True,
    ),
    "company.industry_chain": CapabilityQualityPolicy(
